...
sr.reveal(".history-one__p", { delay: 1800 });

sr.reveal(".history-two__h5", { delay: 2500 });
sr.reveal(".history-two__h1", { delay: 3200 });
sr.reveal(".history-two__p", { delay: 4300 });

sr.reveal(".history-three__h5", { delay: 4500 });
sr.reveal(".history-three__h1", { delay: 5200 });
sr.reveal(".history-three__p", { delay: 6100 });
